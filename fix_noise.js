...
// Replace isNoiseOrNonDeviceText function completely with clean implementation
const sIdxNoise = content.indexOf('function isNoiseOrNonDeviceText(text) {');
const eIdxNoise = content.indexOf('function isStrictHardwareDevice(str) {', sIdxNoise);

if (sIdxNoise === -1 || eIdxNoise === -1) {
  console.error('Could not find isNoiseOrNonDeviceText block');
  process.exit(1);
}

const newNoiseCode = `function isNoiseOrNonDeviceText(text) {
...
console.log('Updated isNoiseOrNonDeviceText successfully!');
