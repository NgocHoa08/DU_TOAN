...
const eIdxLink = content.indexOf('function buildStep2()', sIdxLink);
...
// 4. Update MODEL_PRESETS and CATALOG_ITEMS with full exact commercial device names
const baoAnDevs = require('./baoan_devs.json');
let presetsObj = {};
let catalogArr = [];

const fullCommercialList = [
  { name: 'Máy vi tính để bàn MSI Cubi NUC 1M', model: 'Cubi B0B1', brand: 'MSI', origin: 'Trung Quốc', cat: 'may_tinh', unit: 'Bộ', price: 17800000, origStt: 1 },
  { name: 'Máy tính xách tay MSI Commercial 14 B1MG (MS-14S1)', model: 'MS-14S1', brand: 'MSI', origin: 'Trung Quốc', cat: 'may_tinh', unit: 'Chiếc', price: 17800000, origStt: 2 },
  { name: 'Máy in A4 đen trắng OKI B433DN', model: 'B433DN', brand: 'OKI', origin: 'Thái Lan', cat: 'may_in', unit: 'Chiếc', price: 4800000, origStt: 3 },
  { name: 'Máy quét tài liệu số hóa RICOH SP-2240N', model: 'SP-2240', brand: 'Ricoh', origin: 'Thái Lan', cat: 'may_scan', unit: 'Chiếc', price: 8800000, origStt: 4 },
  { name: 'Thiết bị mạng Switch Cisco CBS350-24S', model: 'CBS350-24S', brand: 'Cisco', origin: 'Trung Quốc', cat: 'thiet_bi_khac', unit: 'Cái', price: 0, origStt: 6 },
  { name: 'Thiết bị mạng Switch Cisco WS-C2960L', model: 'WS-C2960L', brand: 'Cisco', origin: 'Trung Quốc', cat: 'thiet_bi_khac', unit: 'Cái', price: 0, origStt: 7 },
  ...
  { name: 'Thiết bị phòng họp trực tuyến Aver VC520 PRO3', model: 'VC520 PRO3', brand: 'Aver', origin: 'Đài Loan', cat: 'thiet_bi_khac', unit: 'Bộ', price: 56000000, origStt: 9 },
  { name: 'Thiết bị mạng Switch Cisco 24 Port Gigabit', model: '24 Port Gigabit', brand: 'Cisco', origin: 'Trung Quốc', cat: 'thiet_bi_khac', unit: 'Cái', price: 0, origStt: 10 },
  ...
  { name: 'Máy chiếu INFOCUS P162 + phụ kiện', model: 'P162', brand: 'INFOCUS', origin: 'Trung Quốc', cat: 'thiet_bi_khac', unit: 'Bộ', price: 23000000, origStt: 15 },
  ...
  { name: 'Máy in A3 HP LaserJet Pro M706n', model: 'LaserJet Pro M706n', brand: 'HP', origin: 'Trung Quốc', cat: 'may_in', unit: 'Chiếc', price: 18750000, origStt: 18 },
  { name: 'Máy photocopy Ricoh IM 3500', model: 'IM 3500', brand: 'Ricoh', origin: 'Thái Lan', cat: 'photocopy', unit: 'Chiếc', price: 88000000, origStt: 19 }
];
...
console.log('Successfully updated full commercial device names in index.html!');
