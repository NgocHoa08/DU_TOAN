...
// Update linkSpecsToDevices to ensure STT 16 & 17 names and models use offer
...
if (sIdxLink !== -1 && eIdxLink !== -1) {
  const newLinkSpecsCode = `function linkSpecsToDevices(allSpecs) {
      ...
      devs.forEach(function (d, dIdx) {
        ...
        if (lookupStt === 12 && d.model === 'XGS 128') {
  ...
  console.log('Updated linkSpecsToDevices successfully!');
}
